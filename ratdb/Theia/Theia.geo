// EndDetectorFactory recomputes the following geometry components to match
// the values specified in the End_PARAMS table
...
color: [0.8, 0.4, 0.6, 0.5],
drawstyle: "solid"
}

{
name: "GEO",
index: "inner_tarp_top",
valid_begin: [0, 0],
valid_end: [0, 0],
mother: "detector",
type: "tube",
